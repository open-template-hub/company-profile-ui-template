...
export const EMPLOYEES: Employee[] = [
  ...
  },
  {
    profile: {
      name: '???',
      title: 'Full-Stack Developer',
      bio: 'Would you like to join our team? Please feel free to reach us from info@opentemplatehub.com or from jobs page.',
      photoUri:
          '',
      social: {
