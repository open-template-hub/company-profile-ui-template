...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description: 'Store your data efficiently and do not waste your time on your data architecture and performance analysis. Open Template Hub provides you efficient storage, orients and keeps your data in NOSQL and RDBMS, handles connection pools and management.',
    icon: 'fas fa-database',
  },
  {
    title: 'Reliable Design',
    description: 'Shout your business out to the world using responsive user interfaces with handy and highly customizable components.',
    icon: 'fas fa-mobile',
  },
];
